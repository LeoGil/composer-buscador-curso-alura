...
class TestBuscadorDeCursos extends TestCase
{
    ...
    public function testBuscadorDeveRetornarCursos()
    {
        ...
        $this->assertEquals('Curso Teste 1', $cursos[0]->textContent);
        $this->assertEquals('Curso Teste 2', $cursos[1]->textContent);
        $this->assertEquals('Curso Teste 3', $cursos[2]->textContent);
    }
}
